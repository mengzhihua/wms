...
export const outbound = {
  ...
  strategyList: () => http.get('/outbound/wave-strategy/list'),
  strategyCreate: (data) => http.post('/outbound/wave-strategy', data),
  strategyUpdate: (id, data) => http.put(`/outbound/wave-strategy/${id}`, data),
  strategyRemove: (id) => http.delete(`/outbound/wave-strategy/${id}`),
  strategyToggle: (id) => http.post(`/outbound/wave-strategy/${id}/toggle`),
  strategyRun: (data) => http.post('/outbound/wave-strategy/run', data),
  shortagePage: (params) => http.get('/outbound/shortage/page', { params }),
  shortageRegister: (taskId, data) => http.post(`/outbound/shortage/task/${taskId}`, data),
  shortageRegisterWave: (taskId, data) => http.post(`/outbound/shortage/wave-task/${taskId}`, data),
  shortageClose: (id, remark) => http.post(`/outbound/shortage/${id}/close`, { remark }),
  packagePage: (params) => http.get('/outbound/package/page', { params }),
  packageGet: (id) => http.get(`/outbound/package/${id}`),
  packageByOrder: (orderId) => http.get(`/outbound/package/by-order/${orderId}`),
  packageByWave: (waveId) => http.get(`/outbound/package/by-wave/${waveId}`),
  packageBuild: (data) => http.post('/outbound/package/build', data),
  packageManual: (data) => http.post('/outbound/package/manual', data),
  packageUnpack: (orderId) => http.post(`/outbound/package/unpack/${orderId}`),
  packageTracking: (id, data) => http.put(`/outbound/package/${id}/tracking`, data)
}
...
export const inventory = {
  ...
  planPage: (params) => http.get('/inventory/count-plan/page', { params }),
  planGet: (id) => http.get(`/inventory/count-plan/${id}`),
  planCreate: (data) => http.post('/inventory/count-plan', data),
  planUpdate: (id, data) => http.put(`/inventory/count-plan/${id}`, data),
  planSubmit: (id) => http.post(`/inventory/count-plan/${id}/submit`),
  planApprove: (id, data) => http.post(`/inventory/count-plan/${id}/approve`, data),
  planGenerate: (id) => http.post(`/inventory/count-plan/${id}/generate`),
  planComplete: (id) => http.post(`/inventory/count-plan/${id}/complete`),
  planCancel: (id) => http.post(`/inventory/count-plan/${id}/cancel`),
  planReport: (id) => http.get(`/inventory/count-plan/${id}/report`),
  planTasks: (id) => http.get(`/inventory/count-plan/${id}/tasks`),
  planTaskPage: (params) => http.get('/inventory/count-plan/task/page', { params }),
  planTaskDelete: (taskId) => http.delete(`/inventory/count-plan/task/${taskId}`),
  planTaskClaim: (taskId) => http.post(`/inventory/count-plan/task/${taskId}/claim`),
  planTaskAssign: (taskId, assignee) => http.post(`/inventory/count-plan/task/${taskId}/assign`, { assignee }),
  planTaskCount: (taskId, qty) => http.post(`/inventory/count-plan/task/${taskId}/count`, { qty }),
  planRecounts: (id) => http.get(`/inventory/count-plan/${id}/recounts`),
  planRecountCount: (rid, qty) => http.post(`/inventory/count-plan/recount/${rid}/count`, { qty }),
  planRecountNext: (rid) => http.post(`/inventory/count-plan/recount/${rid}/next-round`),
  planRecountConfirm: (rid) => http.post(`/inventory/count-plan/recount/${rid}/confirm`),
  planAdjustGenerate: (id) => http.post(`/inventory/count-plan/${id}/adjust`),
  planAdjustPage: (params) => http.get('/inventory/count-plan/adjust/page', { params }),
  planAdjustGet: (aid) => http.get(`/inventory/count-plan/adjust/${aid}`),
  planAdjustLines: (aid) => http.get(`/inventory/count-plan/adjust/${aid}/lines`),
  planAdjustApprove: (aid, data) => http.post(`/inventory/count-plan/adjust/${aid}/approve`, data),
